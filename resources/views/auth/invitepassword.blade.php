    ...
    <div class="container-fluid mw-1400 mt-5 center-box-wrap">
        <div class="row">
            <div class="col mx-auto mw-560">
                <h2 class="fs-48 fw-600 mb-4 pb-2 mt-5 text-center">Welcome {{ $agentname }}</h2>
                <div class="login-wrap px-2 px-sm-5">
                        ...
                        <div class="col login-form-part ">
                            <form id="login-form" class="m-0 form-app-default" role="form" method="POST" action="{{ url('/setinvitee') }}">
                                {{ csrf_field() }}
