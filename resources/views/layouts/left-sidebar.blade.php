                                ...
                                <div class="console-head-row pt-0 mb-0 pt-2 pl-4 pr-5 border-bottom pb-1">
                                    <div class="col-12 px-0">
                                        <ul id="myTabOptions" data-index="1" class="nav nav-tabs m-0 site-main-tabs">
                                            <li class='d-flex align-items-center'><a href="#" class="text-black fs-20 px-3 py-1 fw-600">Scheduling</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <ul class='list-unstyled mt-3 pt-3'>
                                    <li class="list-item"><a class="sm-link" href="{{url('appointments?sub=type')}}"><span class="sm-link-text text-dgray" >Event Type</span></a></li>
                                    <li class="list-item"><a class="sm-link" href="{{url('appointments?sub=events')}}"><span class="sm-link-text text-dgray" >Event</span></a></li>
                                    <li class="list-item"><a class="sm-link" href="{{url('appointments?sub=tasks')}}"><span class="sm-link-text text-dgray" >Tasks</span></a></li>
                                    <li class="list-item"><a class="sm-link" href="{{url('appointments?sub=calendar')}}"><span class="sm-link-text text-dgray" >Calender</span></a></li>
                                    </ul>
                            </aside>
