...
<link rel="apple-touch-icon" type="image/png" href="https://ngagge.com/assets/img/ngagge-logo.png" />
<meta name="apple-mobile-web-app-title" content="Viddeo">

<link rel="shortcut icon" type="image/x-icon" href="https://ngagge.com/assets/img/ngagge-logo.png" />

<link rel="mask-icon" type="" href="https://ngagge.com/assets/img/ngagge-logo.png" color="#111" />
  ...
  <title>Instant, Free Customer Communication Platform | Free Chat 24/7 Live | Unsubscribe</title>
...
<body translate="no" >
  <div class="container">
	<div class="inner-container">
     ...
     <img src="{{asset('images/ngagge-logo.png')}}">
     </div>
  ...
  <g id="envelope">
	...
	<div class="bottom">
		...
		<p class="subtitle">If you unsubscribe, you will stop receiving our weekly newsletter.
			<p/>
            <input type="hidden" name="customerid" class="form-control" placeholder="Reason To Subscribe" value="{{$userid}}">
			<textarea name="reason" class="form-control" placeholder="Reason To Subscribe"></textarea>
		 
			<div class="buttons" id="">
				<button type="submit" id="unsubscribe">Unsubscribe</button>
				<!-- <button   id="cancel">Cancel</button>
				<button id="go-back">Go back</button> -->
				
			</div>
			<div class="alert alert-info" id="returnres" style="display:none"></div>
		 </form>
	</div>
</div>
...
$(document).ready(function (abc41) {
   $("#unsubscribeform").on('submit',(function(abc41) {
    abc41.preventDefault();
     $("#returnres").hide();
          $.ajax({
             url: "{{url('/PlaybookUnsubscribe')}}",
             type: "POST",
