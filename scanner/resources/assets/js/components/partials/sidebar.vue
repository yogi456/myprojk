                        ...
                        <ul class="list-unstyled" data-list="Channel">
                            <li class="list-item">
                                <div class="ct-dropdown">
                                    <button type="button" class="btn ct-dropdown-toggle text-xdgray border-0 px-0 sm-link pos-rel" @click.prevent="CTDropdown($event)" data-toggle="dropdown">
                                        <span class="sm-link-text">Marketing</span>
                                    </button>
                                    <div class="ct-dropdown-menu pos-stt">
                            ...
                            <li class="list-item">
                                <div class="ct-dropdown dd-2-level">
                                    <button type="button" class="btn ct-dropdown-toggle text-xdgray border-0 px-0 sm-link pos-rel" @click.prevent="CTDropdown($event)" data-toggle="dropdown">
                                    ...
                                    <div class="ct-dropdown-menu pos-stt">
                                        <ul class="dropdown-ul">
                                            ...
                                            <li class="list-item">
                                                <div class="ct-dropdown">
                                                    <button type="button" class="btn ct-dropdown-toggle text-xdgray border-0 px-0 sm-link pos-rel" @click.prevent="CTDropdown($event,'inn')" data-toggle="dropdown">
                                                        <span class="sm-link-text">Scheduling</span>
                                                    </button>
                                                    <div class="ct-dropdown-menu ct-dropdown-menu-child pos-stt">
                                ...
                                <div class="ct-dropdown">
                                    ...
                                    <div class="ct-dropdown-menu pos-stt">
                                        ...
                                        <a class="dropdown-item sm-link" v-bind:href="siteUrl + 'knowledgebase?sub=documents'">
                                            <span class="sm-link-text">Knowledgebase</span>
                                        </a>
                                    </div>
                                </div>
                            </li>
                        ...
                        <ul class="list-unstyled" data-list="Report">
                            <li v-if="isPermission('reports_access')">
                                <a class="sm-link" v-bind:href="siteUrl + 'reports?sub=features'">
                                    <span class="sm-link-text">Metrics</span>
                                </a>
                            </li>
                    ...
                    <div class="side-menu-group text-left" v-show="sideWin.System">
                        ...
                        <ul class="list-unstyled" data-list="System">
                            ...
                            <li class="list-item">
                                <div class="ct-dropdown dd-2-level">
                                    <button type="button" class="btn ct-dropdown-toggle text-xdgray border-0 px-0 sm-link pos-rel" @click.prevent="CTDropdown($event)" data-toggle="dropdown">
                                        <span class="sm-link-text">Conversation Channels</span>
                                    </button>
                                    <div class="ct-dropdown-menu pos-stt">
                                        <ul class="dropdown-ul">
                                            <li class="list-item" v-if="isPermission('chat_settings')">
                                                <div class="ct-dropdown">
                                                    <button type="button" class="btn ct-dropdown-toggle text-xdgray border-0 px-0 sm-link pos-rel" @click.prevent="CTDropdown($event,'inn')" data-toggle="dropdown" v-bind:class="{ disabled: !manageDisabled('chat_settings') }">
                                            ...
                                            <li class="list-item" v-if="isPermission('email_settings')">
                                                <div class="ct-dropdown">
                                                    <button type="button" class="btn ct-dropdown-toggle text-xdgray border-0 px-0 sm-link pos-rel"  @click.prevent="CTDropdown($event,'inn')" data-toggle="dropdown" v-bind:class="{ disabled: !manageDisabled('email_settings') }">
                                            ...
                                            <li class="list-item" v-if="isPermission('facebook_messenger_settings')">
                                                <a class="sm-link" v-bind:href="addLink('facebook_messenger_settings', 'facebook?sub=messenger')">
                                                    <span class="sm-link-text text-dgray">Facebook Messenger</span>
                                                </a>
                                            </li>
                                            <li class="list-item">
                                                <a class="sm-link" v-bind:href="siteUrl + 'addons?sub=gs_sms_messaging'">
                            ...
                            <li class="list-item">
                                <div class="ct-dropdown">
                                    <button type="button" class="btn ct-dropdown-toggle text-xdgray border-0 px-0 sm-link pos-rel"  @click.prevent="CTDropdown($event)" data-toggle="dropdown">
                                        <span class="sm-link-text">Inbox Tools</span>
                                    </button>
                                    <div class="ct-dropdown-menu pos-stt">
                                        <a class="dropdown-item sm-link" v-if="isPermission('routing_set_up')" v-bind:href="addLink('routing_set_up', 'routing')">
                                            <span class="sm-link-text">Routing</span>
                                        </a>
                                        <a class="dropdown-item sm-link" v-if="isPermission('monitoring_access')" v-bind:href="addLink('monitoring_access', 'visitor')">
                                            <span class="sm-link-text">Monitoring</span>
                                        </a>
                                        <a class="dropdown-item sm-link" v-if="isPermission('company_profile_departments_websites_payment_processing')" v-bind:href="addLink('chat_settings', 'shortcuts')">
                            ...
                            <li class="list-item" v-if="isPermission('knowledgebase_website_help_center_setup')">
                                <a class="sm-link" v-bind:href="siteUrl + 'knowledgebase?sub=whc'">
                                    <span class="sm-link-text text-dgray">Website Knowledgebase</span>
                                </a>
                            </li>
...
<script>
    ...
    export default {
        ...
        methods: {
            CTDropdown(event, type = 'outer') {
                let flg = false;
                if ($(event.target).siblings('.ct-dropdown-menu').hasClass('show')) {
                    flg = true;
                }
                if (type === 'outer') {
                    $('.ct-dropdown-menu').removeClass('show');
                    $(event.target).siblings('.ct-dropdown-menu').toggleClass('show');
                } else {
                    $('.ct-dropdown-menu-child').removeClass('show');
                    $(event.target).siblings('.ct-dropdown-menu').toggleClass('show');
                }
                if (flg) {
                    $(event.target).siblings('.ct-dropdown-menu').toggleClass('show');
                    ...
                    $(".app-sidebar a").each(function (ev) {
                        ...
                        setTimeout(function () {
                            if (innThisObj.attr("href") == current || innThisObj.attr("href") + "#" == current) {
                                var obj = $("#side-main-menu a[data-list=" + innThisObj.parents("ul.list-unstyled").data("list") + "]");
                                innThisObj.addClass("active");
                                innThisObj.parent(".dropdown-menu").addClass("show");
                                innThisObj.parents(".ct-dropdown-menu").addClass("show");
//                            innThisObj.parent(".dropdown-menu").addClass("aside-dd-show");
                                obj.parent("li").addClass("active-page");
                                thisObject.sideWin[innThisObj.parents("ul.list-unstyled").data("list")] = true;
                                return 0;
                            }
                        }, 50);
                    });
...
//            var container1 = $(".dropdown-toggle");
//            if (container1.is(e.target) && container1.has(e.target)) {
//                console.log('yes');
//                console.log(container1.siblings(".dropdown-menu").attr('class'));
//                if(container1.siblings(".dropdown-menu").hasClass('show')){
//                    console.log('innn');
//                    setTimeout(()=>{
//                        container1.siblings(".dropdown-menu").removeClass("show");
//                        container1.siblings(".dropdown-menu").removeClass("aside-dd-show");
//                    },2000);
//                }
//            }
//        });
...
//        $("body").on("click", ".sidebar-window .dropdown-toggle", function() {
//            $(".dropdown-menu").removeClass("aside-dd-show");
//            $(this)
//                .siblings(".dropdown-menu")
