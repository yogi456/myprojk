                ...
                <div class="col-6 login-wrap-left d-flex flex-column">
                    <div class="w-100">
                                ...
                                <form id="formAppLogin" class="form-horizontal fs-16 mw-450 mx-auto"  role="form" method="POST" action="{{ url('/login') }}">
                                    ...
                                    <div class="form-group mb-2" >
                                        <!--                                        <a class="btn-link d-flex align-items-center btn-sign-w-google text-center py-0" data-target="#signINNUPWithGoogleModal" data-toggle="modal">
                                                                                    <img src="{{ asset('/images/btn_google_dark_normal_ios@3x.png')}}" alt='google' style="max-height: 58px;margin: -3px;" />
                                                                                    <span class="flex-grow-1">Sign in with Google</span>
                                                                                </a>-->
                                        <a class="btn-link d-flex align-items-center btn-sign-w-google text-center py-0" href="{{ url('auth/google') }}" class="btn btn-block btn-sign-w-google text-black text-center py-2" >
                                            <img src="{{ asset('/images/btn_google_dark_normal_ios@3x.png')}}" alt='google' style="max-height: 58px;" />
                                            <span class="flex-grow-1">Sign in with <label class="notranslate mb-0">Google</label></span>
                                        </a>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="mw-560 mx-auto login-part-content mb-register">
                            ...
                            <div class="">
                                <form action="{{ url('signup')}}" methods="POST" id='formSignupHeader1'>
                                    <div class="form-group">
                                        <label for="" class="fw-600 fs-16">Email</label>
                                    ...
                                    if ($massage == 'The email has already been taken.') {
                                        ...
                                        <span class="text-danger text-center w-100">An account already exists with this email address</span>
                                    <?php } else { ?>
                                        <span class="text-danger text-center w-100">{{$errors->first('email_signup')}}</span> 
                                    <?php } ?>
                                </form>
                            </div>
                            <p class="text-center for-mobile d-none">
                ...
                <div class="col-6 login-wrap-right">
                    <div class="row flex-wrap">
                        <div class="col-auto mx-auto" style="color: red">
                            <form action="{{ url('signup')}}" methods="POST" id='formSignupHeader' class="form-inline justify-content-center">
                                <div class="form-group d-flex">
                                    <input type="email" class="form-control" name="email_signup" id="inputPassword2" placeholder="Your email address">
                                </div>
                                <button type="submit" class="btn bg-dgray text-white" >Free-Forever, Sign up now!</button>
                        ...
                        <div class="mw-750 mx-auto login-part-content">
                            <div class="col-12 text-center mb-5 px-0">
                                <h2 class=" fs-48 fw-700">
                                    <?php
                                    $a = array("Optional Services drive growth", "Optional Services increase sales", "Optional Services generate more profit", "Optional Services leverage <span class='app-title'>ngagge</span>", "Optional Services multiply conversions", "Optional Services save cost");
                                    echo $a[array_rand($a)];
                                    ?>
                                </h2>
                            </div>
                            <div class="row">
                                ...
                                <?php if (in_array('six', $oqTemp)) { ?>
                                    <div class="col-6 addons-feature-single d-flex flex-column"s>
                                        <div class="height-inner p-4">
                                            <div class="h-wrapper mb-3 d-flex align-items-center">
                                                <img class="mr-3" src="{{ asset('/images/icon-mv.png') }}" alt='addon-feature-icon-6'/>
                                ...
                                <?php if (in_array('seven', $oqTemp)) { ?>
                                    ...
                                    <div class="col-6 addons-feature-single d-flex flex-column">
                                        <div class="height-inner p-4">
                                            <div class="h-wrapper mb-3 d-flex align-items-center">
                                                <img class="mr-3" src="{{ asset('/images/icon-bot.png')}}" alt='addon-feature-icon-6'/>
                                                <h1 class="mt-3 fw-600">Build-a-Bot</h1>
                                            </div>
                                            <div class="mh-250">
                                                <div class="inner-section ">
                                                    <div class="row">
