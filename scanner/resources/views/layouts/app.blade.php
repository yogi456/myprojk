...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/jquery.mytour.css')}}">
...
<body id="app-layout" class="<?php echo ((isset(Auth::user()->onboardingGetStarted) && Auth::user()->onboardingGetStarted == 1) ? 'start-intro' : ''); ?> template-{{ collect(\Request::segments())->implode('-') }}">
    <div id="app">
        ...
        <main class="page home-page">
            ...
            <div class="container-fluid main-app-container @yield('body_class')">
                <div>
                    @yield('content')
                </div>
            </div>
    ...
    <script src="{{ asset('js/jquery.csv.min.js') }}" type="text/javascript"></script>
