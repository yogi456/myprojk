...
Route::get('/dev_login', function () {
    return view('content-builder.login');
});
Route::get('/', function () {
    if (isset(Auth::user()->role_id) && Auth::user()->role_id == 5) {
...
Route::get('/ftp-access', 'FtpaccessController@index');
...
})->middleware(['auth','CheckSteps','custom2fa']);
Route::get('/m-get-started', function () {return view('m_get_started');});
// invitee teammate
...
Route::group(['middleware' => 'web', 'middleware' => ['CheckSubscriber', 'custom2fa', 'CheckSteps']], function () {
...
//Route::get('twilio-registration', 'Twillio\TwillioController@twilioRegistration');
...
//Route::get('insertdata','UsersController@checkChatCustomization');
...
Route::get('getTestForwardAndBcc', 'Settings\Email\AddressSelectionController@getTestForwardAndBcc');
...
/*Route::any('/console_log_errors', function (Request $request) {
    file_put_contents('console.log', print_r($request->all(),true),FILE_APPEND); 
});*/
