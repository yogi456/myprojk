...
Route::group(['middleware' => 'web', 'middleware' => ['auth', 'CheckSubscriber', 'custom2fa', 'CheckSteps', 'hasRouteAccess']], function () {
    ...
    /*Bot Sms route Start*/
    Route::any('GetallbotsSms', 'BotsController@GetallbotsSms');
    Route::post('saveDafaultSms', 'BotsController@saveDafaultSms');
    Route::post('UpdateSmsBot', 'BotsController@UpdateSmsBot');
    Route::post('ChangeStatusBotSms', 'BotsController@ChangeStatusBotSms');
    Route::post('deleteBotsSms', 'BotsController@deleteBotsSms');
    Route::post('sortBotsSms', 'BotsController@sortBotsSms');
    Route::post('/bots-Sms/action/create-new-action', 'BotSms\BotSmsActionController@saveBotBuildingAction');
    Route::post('bots-Sms/action/allaction','BotSms\BotSmsActionController@allActionBot');
    Route::get('/bots-Sms/action/delete-child-action', 'BotSms\BotSmsActionController@deleteChildAction');
    Route::post('bots-sms-report', 'BotSms\BotSmsActionController@GetactionReport');
    
     Route::get('sendmsgtest', 'BotSms\BotThreadController@index');//check send msg 
    /*Bot Sms route End*/  																													
});
...
Route::group(['middleware' => 'web', 'middleware' => 'hasRouteAccess'], function () {
   ...
   /*Bot sms route Start*/
    Route::get('/bots-sms/action/get-category', 'BotSms\BotSmsActionController@getBotActionCategory');
    Route::get('/bots-sms/action/get-bot-chart-flow-order', 'BotSms\BotSmsActionController@getBotChartFlowOrder');
    Route::get('/bots-sms/action/get-bot-chart-flow-order-fn', 'BotSms\BotSmsActionController@getBotChartFlowOrderfn');
   /*Bot sms route End*/

   /*get assignee by event data*/
    Route::post('/get-assignee-event', 'WebIframeController@GetAssignee');
