        ...
        <div id="wrapper" style="max-width: 600px;margin: 20px auto; padding: 30px 15px;">
            <header class="email-header">
                <a href="<?php echo e(url('/')); ?>" target="_blank">
                    <img class="logo" src="<?php echo e(url('/')); ?>/img/logo.png" alt="logo" style="max-width: 175px;margin-bottom: 15px;">
                </a>
            </header>
            <div class="email-content">
                <p style="margin-bottom: 16px;">Hi Irefill Admin, </p>
                  ...
                  <p style="margin-bottom: 16px;"><strong>Name : </strong><br/> <?php echo e($name); ?></p>
                  <p style="margin-bottom: 16px;"><strong>Email : </strong><br/> <?php echo e($email); ?></p>
                           <p style="margin-bottom: 16px;"><strong>Subject : </strong><br/> <?php echo e($subject); ?></p>
                  <p style="margin-bottom: 16px;"><strong>Message : </strong><br/> <?php echo e($msg); ?></p>

                
            </div>
            <div class="email-footer">
                <a href="<?php echo e(url('/')); ?>" target="_blank">
                    <img class="logo" src="<?php echo e(url('/')); ?>/img/logo.png" alt="logo" style="max-height: 25px;">
                </a>
            </div>
        </div>
    </body>
