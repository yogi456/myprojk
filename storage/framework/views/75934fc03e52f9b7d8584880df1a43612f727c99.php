...
<div class="send-message">
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            <div class="contact-form">
              <form id="sell" action="<?php echo e(url('sellSubmit')); ?>" method="post">
                <div class="row">
     ...
     function  checkprice(argument) {
      ...
      if(bottleop==1){
      $("#bottle_price").val('<?php echo e($setting->bottle_price); ?>');
      }else{
      	 $("#bottle_price").val('0')
      }
     ...
     function loadQuantity(proid) {
            ...
            $.ajax({
                type: 'get',
                url: '<?php echo e(url("loadQuantity")); ?>/'+proid,
       ...
       function quantitycheck(id){
       	  $.ajax({
                type: 'get',
                url: '<?php echo e(url("quantityData")); ?>/'+id,
